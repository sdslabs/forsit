...
for i in problem_result:
	pid = str(i[0])
	a = problem.problem(pid = pid, app_name = app_name, cfs_max_score = cfs_max_score, lower_threshold = lower_threshold, upper_threshold = upper_threshold, number_to_recommend = number_to_recommend)
